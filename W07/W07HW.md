### P1. 請開始做期中project的第一個主動學習，相關的程式碼及md檔可以先放在 docs/id_name1/1_active/ 目錄下，如上圖。完成後，再將active1.md, active1.pdf檔複製放入 docs/answers-md/1_active/ 目錄中。請插入 active1.md code。 
